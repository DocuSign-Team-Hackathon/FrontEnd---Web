    ...
    <Router>
      ...
      <Header />
        <Box paddingLeft="100px" paddingTop="50px">
            <Heading color="black">Pets available for <Text as="span" color="#C2392E"><Link to="/dogpage">Adoption</Link></Text> </Heading>
        </Box>
        ...
        {Dogs.map((dog) => {
          return (
            <Box  margin="30px" padding="20px"  borderRadius="5px" dropShadow="8px 10px 8px black" key={dog.id}>
              ...
              <Box boxShadow="lg" p="6" rounded="md" bg="white" padding="15px" width="280px"  margin="auto">
                <Heading color="#C2392E" fontSize="2xl">{dog.name}</Heading>
                <Text fontSize="0.9rem" padding="5px"color="black">{dog.age}, {dog.size}, {dog.gender}, {dog.type}</Text>
              </Box>
            </Box>
          )
        })}
