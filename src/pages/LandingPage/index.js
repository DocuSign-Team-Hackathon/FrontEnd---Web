...
//         <Box bgImage="url('./assets/headerImage.png')" h="100vh" backgroundSize="1900px" backgroundPosition="center right top "backgroundRepeat="no-repeat" >
//         <Header />
...
//               <Button margin="10px" bg="tomato" w="20%" p={4} color="white"><Link to="/adopt">Adpot Today</Link></Button>
//           </Box>
//         </Box>
...
//               <Text margin="10px" color="white" fontSize="6xl">Don’t Buy, <Text as="span" color="#C2392E" >Adopt!</Text></Text>
//               <Box width="30%"><Text margin="10px" color="white" frontSize="2x1">The unknown truth is that these animals like us, are conscious beings with their own personality  and feelings. They deserve our respect and  should be treated as equals.</Text></Box>
//               <Button margin="10px" bg="tomato" w="20%" p={4} color="white"><Link to="/dogpage">AVAILABLE PETS</Link></Button>
//           </Box>
//         </Box>
//         <Box padding="100px" > 
...
//                     <Image src="./assets/checkblog1.jpg" h="350px" borderRadius="20px" />
//                     <Text position="absolute" bottom="10px" color="white" textAlign="center" padding="10px">Seeking Dog Foster Coordinator Animal Transfer Coordinator </Text>
//                     </a>
//                   </Container>
//                 </Box>
//                 <Box>
...
//                     <Image src="./assets/checkblog2.jpg" h="350px" borderRadius="20px" />
//                     <Text position="absolute" bottom="10px" color="white" textAlign="center"  padding="12px" >Bissell Empty the Shelters adoption event! July 7-11 </Text>
//                     </a>
//                   </Container>
//                 </Box>
//                 <Box>
...
//                   <Image src="./assets/checkblog3.jpg" h="350px"  borderRadius="20px" />
//                     <Text position="absolute" bottom="10px" color="white" textAlign="center" padding="10px" > OAS is now open on Thursdays! 5-7 pm for walk-in adoptions</Text>
//                     </a>
//                   </Container>
//                 </Box>
//               </Box>
